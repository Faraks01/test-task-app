import {EditCharacterFormActions, EditCharacterFormData} from "@/features/character/EditCharacter/model";
...
export const useEditCharacterForm = (initFormData: EditCharacterFormData): UseEditCharacterFormReturnType => {
  const {
    form,
    setFormField,
    resetForm,
